...
<p class="fs-5 light">Los mejores instrumentos, las mejores marcas al mejor precio posible las encontras en All Music</p>
</div>
`
...
const mostrarProductos = async () => {
    ...
    boton.addEventListener('click', () => {
        Swal.fire({
            toast: true,
            position: 'top-end',
            background: 'rgb(191,191,191) linear-gradient(0deg, rgba(191,191,191,1) 0%, rgba(215,67,67,1) 90%)',
...
window.onscroll = function () {
    if (document.documentElement.scrollTop < 500) {
        document.querySelector('.goCartContainer')
